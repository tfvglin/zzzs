var rightImagePath = "<span style='background:url(../images/messageiconr1.png) no-repeat;_display:inline;padding-left:30px;margin-top:5px;'/>";
var wrongImagePath = "<span style='background:url(../images/messageiconw1.png) no-repeat;_display:inline;padding-left:30px;margin-top:5px;'/>";
...
AntSoft.CHK.caChecker.prototype.chk_idcard=function(elem,role){
	var chkInfoLayout=CACHK.makeInfoLayoutElement(role);
	chkInfoLayout.className="cachk_initsLayout";
	chkInfoLayout.innerHTML="<img src = '../images/loading.gif' alt = '查询' height = '16'/>";
	var v=CACHK.trim(elem.value);
	//1.为空较验
	if(v==""){
		CACHK.showErrors(elem,role,"不能为空",arguments[2]);
