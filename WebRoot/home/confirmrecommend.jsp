...
<div>
  <div class="mainwrap">
    <div class="navtitle yahei" style="font-size:16px;text-indent:10px;border-bottom:1px solid #ddd;line-height:65px;">
      <span  style="font-size:24px;">提示</span></div>
					<div class="nofixedwide">
						<div class="message">
							<div class="messagewrap">
								...
								<div class="txt">
									<h2 class="yahei">
										<span class="orangefont">您确定提交本申请表吗？</span>
									</h2>
									<p>
										<span class="orangefont">提交后本表格将不可以再修改。</span>
									</p>
								</div>
								<div class="right">
									<a href="confirmRecommend" class="linkbtn btnred">确定提交</a>
									<a href="previewRecommend" class="linkbtn btngrey" target="_blank">预览申请表</a>
								</div>
							</div>
						</div>
					</div>
