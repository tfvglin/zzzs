...
<div class="fixedwide">
    <!--<div style="float:right;" >
				<p class="rightbtn">
				    <a href="/zzzs/home/athlete.jsp" class="linkbtn">&laquo; 返回</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </p>
	</div>-->
	<div class="tips" id="noprint">
	    <s:if test='#request.status!="尚未提交申请表"&&#request.status!="尚未提交高水平运动员申请表"'><div class="leftbtn">
    ...
    <div class="printtable" id="myPrintArea">
		<div class="clearfix" width="922">	    
		    <div class="title">
		        ...
		        <br />
		        <span class="titlename" style="font-size: 25px;text-align:center">2015年高水平运动员选拔考试</span>
		        <br />
	...
	<div class="clearfix" style="width:95%;">
			...
			<div class="athleteadmissionpersonal">    
           ...
           <div class="athleteadmissionexam">
