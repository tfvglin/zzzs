...
public class RecommendContactAction extends ActionSupport{
	...
	public String execute() throws Exception
	{
		...
		String FirstRelation=userService.getFirstRelation("zsb_recommend",IDcard);//获取课程名称
		String FirstName=userService.getFirstName("zsb_recommend",IDcard);//获取开始时间
		String FirstUnit=userService.getFirstUnit("zsb_recommend",IDcard);//获取结束时间
		String FirstEdu=userService.getFirstEdu("zsb_recommend",IDcard);//获取课程名称
		String FirstTel=userService.getFirstTel("zsb_recommend",IDcard);//获取开始时间
		String SecondRelation=userService.getSecondRelation("zsb_recommend",IDcard);//获取课程名称
		String SecondName=userService.getSecondName("zsb_recommend",IDcard);//获取开始时间
		String SecondUnit=userService.getSecondUnit("zsb_recommend",IDcard);//获取结束时间
		String SecondEdu=userService.getSecondEdu("zsb_recommend",IDcard);//获取课程名称
		String SecondTel=userService.getSecondTel("zsb_recommend",IDcard);//获取开始时间
