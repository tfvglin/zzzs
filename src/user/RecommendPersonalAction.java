...
public class RecommendPersonalAction extends ActionSupport{
	private String xm;
	private String xbm;
	private String mzm;
	private String ssm;
	...
	public String execute() throws Exception
	{
		...
		iNo=userService.infoUtil("zsb_recommend",IDcard,getXm(),getXbm(),getMzm(),getSsm(),getCsrq(),getZzmmm(),getLanguage(),getKslbm(),getXklb());
