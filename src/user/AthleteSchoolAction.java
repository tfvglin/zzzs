...
public class AthleteSchoolAction extends ActionSupport{
	...
	public String execute() throws Exception
	{
		...
		iNo=userService.studyUtil("zsb_athlete",IDcard,getHighschool(),getHighlink(),getHighdepartment(),getHighlinktel(),getHighaddress(),getHighpost(),getHighbegin(),getHighend(),getMidschool(),getMidlink(),getMidbegin(),getMidend());
